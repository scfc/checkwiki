...
$param_pageid    = q{} unless defined $param_pageid;
...
sub connect_database {
    ...
    $dsn = "DBI:mysql:p50380g50450__checkwiki_p;mysql_read_default_file=my.cnf";
...
{
    print redirect( -url => 'https://tools.wmflabs.org/checkwiki/' );
}
    ...
    and $param_id     =~ /^[0-9]+$/ )
{
    ...
    my $sql_text =
        "update cw_error set ok=1 where error_id="
      . $param_pageid
      . " and error="
      . $param_id
      . " and project = '"
    ...
    and $param_pageid =~ /^[0-9]+$/ )
{
    ...
    my $dbh = connect_database();
    my $sql_text =
        "select title from cw_error where error_id="
      . $param_pageid
      . " and project = '"
      . $param_project
      . "' limit 1;";
